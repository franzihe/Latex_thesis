...
\begin{figure}[t]\ContinuedFloat
	...
	\centering
	%     % 24/12
	% 		\begin{subfigure}[t]{\textwidth}		\includegraphics[trim={0cm 0cm 18.3cm 5.1cm},clip,width=0.8\textwidth]{./fig_09EM/20161224}
	...
	% 		\end{subfigure}
	%     % 25/12
	% 		\begin{subfigure}[t]{\textwidth}		\includegraphics[trim={0cm 0cm 18.3cm 5.1cm},clip,width=0.8\textwidth]{./fig_09EM/20161225}
