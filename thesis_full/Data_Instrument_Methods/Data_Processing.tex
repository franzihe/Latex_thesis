...
\end{align}
The coefficient of variation is known as the standard deviation with respect to their mean of the model output. That means it shows the variation around the center or control run.
...
\begin{align}
	MAE = \frac{\sum_{i=1}^n \left| MEPS_{ens} - DoFe_{obs}\right|}{N}
\end{align}
