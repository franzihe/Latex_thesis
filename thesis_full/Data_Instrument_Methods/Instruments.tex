...
\par\medskip\noindent
Particle images from PIP and MASC were analysed for \num{21} to \SI{26}{\dec} by the University of Utah. In this thesis this the result of the University of Utah was used to determine habit and rimed particles to apply to the optimal estimation retrieval (\Cref{sec:retrieval}) and perform a sensitivity study (\ref{sec:ret:sensitivity}).
