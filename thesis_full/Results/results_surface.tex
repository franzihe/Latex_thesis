...
A detailed insight to the orographical wind influence will be assessed in \Cref{sec:res:oro_infl}. On the \num{25} and \SI{26}{\dec}, MEPS also overestimated the precipitation amount at the surface, reasons for this will be further discussed in \Cref{sec:sfc_acc}.
