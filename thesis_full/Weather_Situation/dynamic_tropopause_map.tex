...
\end{minipage}\hfill
\begin{minipage}[b]{.44\textwidth}
	\captionof{subfigure}{Atmospheric river analysis map. IVT, shaded according to the colour bar [\SI{}{\IVT}]. Vectors, indicating the direction and magnitude of the IVT. } \label{fig:AR24_pres}
\end{minipage}
\captionof{figure}{ECMWF analysis on \SI{24}{\dec} at \SI{12}{\UTC}.}\label{fig:24_12_pres}
