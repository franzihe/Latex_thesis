...
\newcommand{\duo@page@iii}{%
	\begin{titlepage}
		...
		\raggedright
		\vfill \footnotesize{Satellite image of the extreme extratropical cyclone on 24 December 2016 at the coast of Norway. Image obtained from the Dundee Satellite Receiving Station \url{http://www.sat.dundee.ac.uk}.}
	\end{titlepage}
}
