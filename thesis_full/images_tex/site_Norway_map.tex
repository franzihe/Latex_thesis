...
\begin{figure}[!t]
  \begin{tabular}[t]{cc}
    ...
    \end{tabular}
  \end{tabular}
  \caption{Model elevation map of Northern Europe (\protect\subref{fig:site:Norway}) and Southern Norway (\protect\subref{fig:site:Nzoom}), where the model domain of MEPS are presented in Lambert projection. The elevation corresponds to the legend of \protect\subref{fig:site:Nzoom}. A topographic map of the measurement site is shown in \protect\subref{fig:site:kartverket} with DTM 10 Terrain Model (UTM33) from \cite{geonorge_dtm_2018}.} \label{fig:site}
\end{figure}