...
\begin{table}[H]
	\begin{center}
		\caption{Typical reflectivity values, according to \cite{doviak_doppler_1993}, obtained from measurements, models, and observations. The rainfall rate $R$ is calculated with \Cref{eq:Z-R}. }\label{tab:ref_values}
