...
\begin{table}[t!]
	\begin{center}
		\caption{Typical reflectivity values for different precipitation types, obtained from measurements, models, and observations. The rainfall rate $R$ is calculated with \Cref{eq:Z-R} \citep{doviak_doppler_1993}. }\label{tab:ref_values}
